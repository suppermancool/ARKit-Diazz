...
class VirtualObjectSelectionViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
	...
	func getObject(index: Int) -> VirtualObject {
        ...
        case 6:
            return Snow()
        case 7..<(7+Manager4CustomObject.shared.numberOfFile):
            return DownloadObject(index: index - 7)
		default:
			return Cup()
		}
	}
	...
	func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
		return VirtualObjectSelectionViewController.COUNT_OBJECTS + Manager4CustomObject.shared.numberOfFile
	}
